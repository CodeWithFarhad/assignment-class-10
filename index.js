...
{
    let currentUsers = ["Hadi", "Fatima", "Dawood", "Ayesha", "Waleed"];
    let newUsers = ["Hadi", "Qamar", "Ali", "Sadia", "Waleed"];
...
{
    let favPizzas = ["ExtraCheese", "Fagita", "BBQ"];
...
// Magicians: Make a array of magician’s names. Pass the array to a function called show_magicians(), which prints the name of each magician in the array.
{
    ...
    let magicianNames = ["Harry Potter", "Geralt", "Aib Ken"];
